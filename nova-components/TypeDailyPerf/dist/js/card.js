...
Nova.booting(function (Vue, router, store) {
  Vue.component('type-daily-perf', __webpack_require__(2));
});
    ...
    methods: {
        loadDailySummary: function loadDailySummary() {
            ...
            axios.get('/nova-vendor/' + this.card.component + '/daily-summary', [], {
                ...
                _this.rows = response.data.data.daily_summary;
                            ...
                            _vm._l(_vm.rows, function(row, key) {
                              return _c(
                                ...
                                [
                                  ...
                                  _vm._v(" "),
                                  _c("td", [
                                    _vm._v("$" + _vm._s(row.tot_spend))
                                  ]),
                                  _vm._v(" "),
                                  _c("td", [
                                    _vm._v("$" + _vm._s(row.tot_revenue))
                                  ]),
                                  _vm._v(" "),
                                  _c("td", [
                                    _vm._v("$" + _vm._s(row.tot_profit))
                                  ]),
                                  _vm._v(" "),
                                  _c("td", [_vm._v(_vm._s(row.tot_roi) + "%")]),
                                  _vm._v(" "),
                                  _c("td", [
                                    _vm._v("$" + _vm._s(row.yahoo_spend))
                                  ]),
                                  _vm._v(" "),
                                  _c("td", [
                                  ...
                                  _vm._v(" "),
                                  _c("td", [
                                    _vm._v(_vm._s(row.yahoo_roi) + "%")
                                  ]),
                                  _vm._v(" "),
                                  _c("td", [
                                    _vm._v("$" + _vm._s(row.media_spend))
                                  ]),
                                  _vm._v(" "),
                                  _c("td", [
