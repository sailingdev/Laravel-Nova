...
use App\Http\Controllers\FbReporting\CreateCampaignsFromTemplateController;
...
Route::post('/submit-keywords', [CreateCampaignsFromTemplateController::class, 'submit']);
