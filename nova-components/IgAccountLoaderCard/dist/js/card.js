...
Nova.booting(function (Vue, router, store) {
  Vue.component('ig-account-loader-card', __webpack_require__(5));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SubmitForm__ = __webpack_require__(10);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("0bbd4657", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
                ...
                _c(
                  ...
                  _vm._l(_vm.igAccounts, function(igAccount, key) {
                    return _c(
                      ...
                      [
                        _c("div", [_vm._v(_vm._s(igAccount.facebook_page_id))]),
                        _vm._v(" "),
                        _c("div", [
